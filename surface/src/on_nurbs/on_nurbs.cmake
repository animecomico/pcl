...
IF(USE_UMFPACK)
	...
	IF(WIN32)
		IF(MSVC)
			#Use https://github.com/jlblancoc/suitesparse-metis-for-windows.git TO MSVC
			FIND_PACKAGE(SuiteSparse NO_MODULE)
			set(SuiteSparse_USE_LAPACK_BLAS ON)
			INCLUDE(${USE_SuiteSparse})		
			LINK_DIRECTORIES(${SuiteSparse_LIB_DIR})
			LINK_DIRECTORIES(${SuiteSparse_LAPACK_BLAS_LIB_DIR})
			SET(ON_NURBS_LIBRARIES ${SuiteSparse_LIBRARIES} ${SuiteSparse_LAPACK_BLAS_LIBRARIES})
		ENDIF(MSVC)
	ELSE()
